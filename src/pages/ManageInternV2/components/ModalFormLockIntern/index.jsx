...
import { createIntern, getMasterDataSelection, lockInternList } from '../../../../api/axios';
import { notificationError } from '../../../../components/Notification';

export function ModalFormLockIntern({ onSuccess, openForm, onChangeClickOpen }) {
  const handleLockInternList = (values) => {
    lockInternList(values).then((res) => {
