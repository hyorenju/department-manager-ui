...
import img from '../../../../assets/img/import-class-require.png';

export const ModalErrorImportClass = ({ open, setOpen }) => {
  const handleClickOk = () => {
    setOpen(false);
  };
  return (
    <>
      <Modal
        ...
        title={
          <h1 className="text-sky-900 text-2xl font-bold">
            Hướng dẫn import tệp excel danh sách lớp
          </h1>
        }
        open={open}
      ...
      >
        ...
        <Image src={img} alt="Mẫu file danh sách lớp" className="w-full h-full object-cover" />
      </Modal>
    </>
  );
};
