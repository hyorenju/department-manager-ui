...
import img from '../../../../assets/img/import-subject-require.png';

export const ModalErrorImportSubject = ({ open, setOpen }) => {
  const handleClickOk = () => {
    setOpen(false);
  };
  return (
    <>
      <Modal
        ...
        title={
          <h1 className="text-sky-900 text-2xl font-bold">
            Hướng dẫn import tệp excel danh sách môn học
          </h1>
        }
        open={open}
      ...
      >
        ...
        <Image src={img} alt="Mẫu file danh sách môn học" className="w-full h-full object-cover" />
      </Modal>
    </>
  );
};
